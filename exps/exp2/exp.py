...
def fast_sgd_fullback(dbtype = 'leveldb', dbno = 1):
	...
	for gstep in xrange(2):
		...
		cnn.save_img_ind(input_orig, path = src_path+'/exp2/fast_sgd', tag = str(gstep), tr = False)
	...
	np.save(src_path+'/exp2'+'/results/fbnodrop_prob',c_prob1)
	np.save(src_path+'/exp2'+'/results/fballdrop_ap_prob',c_prob2)
	np.save(src_path+'/exp2'+'/results/fbfcdrop_ap_prob',c_prob3)
	np.save(src_path+'/exp2'+'/results/fballdrop_prob',mc_prob2)
	np.save(src_path+'/exp2'+'/results/fbfcdrop_prob',mc_prob3)
	np.save(src_path+'/exp2'+'/results/fbimg_adv',img_adv)
