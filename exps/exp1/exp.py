...
def fast_sgd_fullback(dbtype = 'leveldb', dbno = 1):
	...
	np.save(src_path+'/exp1'+'/results/yt_sfb_noise2',cnn.yt)
	...
	for gstep in xrange(gsteps):
		...
		input_orig -= input_grads*7.e-2

		
	
	#save the images 
	
	np.save(src_path+'/exp1'+'/results/s3minus_noise_fbnodrop_prob',c_prob1)
	np.save(src_path+'/exp1'+'/results/s3minus_noise_fballdrop_ap_prob',c_prob2)
	np.save(src_path+'/exp1'+'/results/s3minus_noise_fbfcdrop_ap_prob',c_prob3)
	np.save(src_path+'/exp1'+'/results/s3minus_noise_fballdrop_prob',mc_prob2)
	np.save(src_path+'/exp1'+'/results/s3minus_noise_fbfcdrop_prob',mc_prob3)
	np.save(src_path+'/exp1'+'/results/s3minus_noise_fbimg_adv',img_adv)
