...
def fast_sgd_fullback(dbtype = 'leveldb', dbno = 1):
	...
	np.save(src_path+'/exp1'+'/results/finfp_fbnodrop_prob',c_prob1)
	np.save(src_path+'/exp1'+'/results/finfp_fballdrop_ap_prob',c_prob2)
	np.save(src_path+'/exp1'+'/results/finfp_fbfcdrop_ap_prob',c_prob3)
	np.save(src_path+'/exp1'+'/results/finfp_fballdrop_prob',mc_prob2)
	np.save(src_path+'/exp1'+'/results/finfp_fbfcdrop_prob',mc_prob3)
	np.save(src_path+'/exp1'+'/results/finfp_fbimg_adv',img_adv)
