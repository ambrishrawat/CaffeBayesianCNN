...
def fast_sgd_fullback(dbtype = 'leveldb', dbno = 1):
	...
	for gstep in xrange(2):
		...
		cnn.save_img_ind(input_orig, path = src_path+'/exp1/fast_sgd_noise', tag = str(gstep), tr = False)
	...
	np.save(src_path+'/exp1'+'/results/nfbnodrop_prob',c_prob1)
	np.save(src_path+'/exp1'+'/results/nfballdrop_ap_prob',c_prob2)
	np.save(src_path+'/exp1'+'/results/nfbfcdrop_ap_prob',c_prob3)
	np.save(src_path+'/exp1'+'/results/nfballdrop_prob',mc_prob2)
	np.save(src_path+'/exp1'+'/results/nfbfcdrop_prob',mc_prob3)
	np.save(src_path+'/exp1'+'/results/nfbimg_adv',img_adv)
