...
def fast_sgd_fullback(dbtype = 'leveldb', dbno = 1):
	...
	for gstep in xrange(gsteps):
		...
		input_orig -= input_grads*0.2e-3

		
	
	#save the images 
	
	np.save(src_path+'/exp1'+'/results/slow_in_fp_fbnodrop_prob',c_prob1)
	np.save(src_path+'/exp1'+'/results/slow_in_fp_fballdrop_ap_prob',c_prob2)
	np.save(src_path+'/exp1'+'/results/slow_in_fp_fbfcdrop_ap_prob',c_prob3)
	np.save(src_path+'/exp1'+'/results/slow_in_fp_fballdrop_prob',mc_prob2)
	np.save(src_path+'/exp1'+'/results/slow_in_fp_fbfcdrop_prob',mc_prob3)
	np.save(src_path+'/exp1'+'/results/slow_in_fp_fbimg_adv',img_adv)
